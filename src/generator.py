...
CONFIG_P = (PLANES_RANGE_P, MANEUVERS_RANGE_P, DENSITY_RANGE_P, INSTANCES_RANGE_5)

PLANES_RANGE_P2 = range(45, 60, 1)
MANEUVERS_RANGE_P2 = range(15,16)
DENSITY_RANGE_P2 = range(8,9)
CONFIG_P2 = (PLANES_RANGE_P2, MANEUVERS_RANGE_P2, DENSITY_RANGE_P2, INSTANCES_RANGE)
...
# function of density
DENSITY_RANGE_D = range(15, 30, 1)
PLANES_RANGE_D = range(20, 21)
MANEUVERS_RANGE_D = range(20,21)
CONFIG_D = (PLANES_RANGE_D, MANEUVERS_RANGE_D, DENSITY_RANGE_D, INSTANCES_RANGE_5)

# function of density
DENSITY_RANGE_D2 = range(20, 35, 1)
PLANES_RANGE_D2 = range(10, 11)
MANEUVERS_RANGE_D2 = range(30,31)
CONFIG_D2 = (PLANES_RANGE_D2, MANEUVERS_RANGE_D2, DENSITY_RANGE_D2, INSTANCES_RANGE_5)

if __name__ == "__main__":
    generate_instances(*CONFIG_D2)
